...
#resim yolunu tanımlama
image_path = '/path/to/image.png'

#resmi aç
image = Image.open(image_path)

#resimdeki dili tanımla
specified_language = 'deu'

# print("Belirlenen dil:", specified_language)

# OCR ile metni oku
result = pytesseract.image_to_string(image, lang=specified_language)
